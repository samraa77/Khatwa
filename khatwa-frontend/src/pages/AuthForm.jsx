...
useEffect(() => {axios.get('https://api.countrylayer.com/v2/all?access_key=7534a478f9fe9d346823b87b3fc7010f')
.then(res => {
...
try {
// await axios.post('[http://127.0.0.1:8000/api/register](http://127.0.0.1:8000/api/register)', {
// ...formData,
...
e.preventDefault();
try {
await axios.post('[http://127.0.0.1:8000/api/login](http://127.0.0.1:8000/api/login)', loginData);
setIsLoggedIn(true);
} catch (err) {
...
return ( <div className="body-auth">
    ...
    <div className="form-container sign-up-container">
      <form onSubmit={handleSignUpSubmit}>
        ...
        <div className="social-container">
         ...
         <span>ou utilisez votre donnee</span>
